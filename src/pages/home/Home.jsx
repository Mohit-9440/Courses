    ...
    <div className="home-wrapper">
      <div className="home">
        ...
        <div className="home-page">
          ...
          <section className="home-second-section-wrapper">
            <div className="home-second-section">
              <div className="home-second-section-left">
                ...
                <div className="home-second-section-left-ul-wrap">
                  <ul className="home-second-section-left-ul">
                    <li className="home-second-section-left-li">
              ...
              <div className="home-second-section-right">
                <div className="home-second-section-right-img">
                  <img className="home-banner" src={SecondBanner} alt="" />
                </div>
              </div>
            </div>
          </section>
