  ...
  const [enrolledCourses, setEnrolledCourses] = useState([
    {
      ...
      thumbnail: 'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      dueDate: '2024-12-31',
      progress: 90,
      completed: false,
    },
    {
      ...
      thumbnail: 'https://images.unsplash.com/photo-1527689368864-3a821dbccc34?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      dueDate: '2024-12-31',
      progress: 60,
      completed: false,
    },
      ...
      <div className="dashboard">
        ...
        <div className="dashboard-page">
          <section className="dashboard-top-wrapper">
            <div className='dashboard-top-wrapper-heading'>Courses Enrolled</div>
          </section>
                 ...
                 >
                  ...
                  <div className="dashboard-bottom-card-bottom">
                    ...
                    <div className="dashboard-bottom-card-bottom-second">
                      ...
                      <div  style={{marginTop: "10px"}} className="dashboard-bottom-card-bottom-button-con">
                          <button
                        ...
                        {course.completed && <span style={{color:"green"}}>Completed</span>}
                    </div>
                  </div>
                </div>
              ))}
